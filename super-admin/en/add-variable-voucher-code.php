...
<?php
   ...
   if(isset($_POST['add_voucher_code'])){
       ...
       $query = "INSERT INTO `variable_voucher_code`(`id`,`voucher_id`,`voucher_code`,`timestamp`) VALUES (NULL,$voucher_id,'$voucher_code',$timestamp)";
...
<html lang="en">
   <head>
      ...
      <title>Add Variable Voucher Code | My Voucher World </title>
      <!-- Google font-->
                  ...
                  <div class="row product-adding">
                     <div class="card">
                        <div class="card-header">
                           <h5>Add Variable Voucher Code</h5>
                        </div>
                        <div class="card-body">
