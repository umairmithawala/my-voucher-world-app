...
<html lang="en">
   <head>
      ...
      <title>Variable Voucher List | My Voucher World Admin</title>
      <!-- Google font-->
                        ...
                        <div class="card">
                           ...
                           <div class="card-body" style="overflow-x:auto;">
                              <table class="table table-striped">
                                 ...
                                 <tbody>
                                    <?php
                                       $query1    = "SELECT * FROM variable_voucher WHERE `is_deleted` = 0";
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <?php
                                             echo $data1['min_price']."₹ - ".$data1['max_price']."₹";
                                             ?>
                                       </td>
                                       <td>
                                          <?php
                                       ...
                                       <td class="text-center" style="min-width:100px;">
                                          ...
                                          &nbsp;
                                          <a href="delete/delete-variable-voucher.php?id=<?php echo $data1['id']; ?>">
