...
<html lang="en">
   <head>
      ...
      <title>Login | My Voucher World </title>
      <!-- Google font-->
                  ...
                  <div class="col-md-5 p-0 card-left">
                     <div class="card bg-primary">
                        ...
                        <div class="single-item">
                           <div>
                              <div>
                                 <h3>Welcome to My Voucher Admin Panel</h3>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="card tab2-card">
                        <div class="card-body">
                           ...
                           <div class="tab-content" id="top-tabContent">
                              ...
                              <div class="alert alert-danger alert-dismissible" id="login_alert" style="display:none;">
...
<script>
    var login_alert = <?php echo $alert; ?>;
    if(login_alert == 1){
