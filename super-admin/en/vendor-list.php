...
<html lang="en">
   <head>
      ...
      <title>Vendor List - Admin | My Voucher World</title>
      <!-- Google font-->
                              ...
                              <table class="display" id="basic-1">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <?php echo $data1['vendor_api_key']; ?>
                                       </td>
                                       <td>
                                          <?php echo $data1['vendor_api_secret']; ?>
                                       </td>
                                    
                                       <td class="text-center">
                                          <?php
                                             if($data1['is_deleted'] == 1){
                                                 ?>
                                          

                                          <i class="fas fa-circle" style="color: #F93154;"></i>
                                          <?php
                                             }else if($data1['is_deleted'] == 0){
                                                 ?>
                                          

                                          <i class="fas fa-circle" style="color: #00B74A;"></i>
                                          <?php
                                             }
