...
<?php 
   if (!empty($_GET['id'])) {
       ...
       $query = "SELECT * FROM `variable_voucher` WHERE `id` = $voucher_id";
...
<html lang="en">
   <head>
      ...
      <!-- Price Range bootstrap css from W3School -->
   ...
   <body>
      ...
      <div class="container-fluid mt-4">
            ...
            <div class="col">
               <div class="favorite" style="float:right;">
                  <?php
                     ...
                     $query1 = "SELECT `id` FROM `favorite` WHERE `user_id` = $user_id AND `voucher_id` = $voucher_id AND `voucher_type` = 'dynamic'";
                     ...
                     if($already_favorite == 0){
                         ...
                         ?>
                  <a href="add-to-favorite.php?id=<?php echo $voucher_id ?>&type=dynamic" style="text-decoration:none; color:#111;">
                  ...
                  <?php
                         ...
                         ?>
                  <a href="remove-from-favorite.php?id=<?php echo $voucher_id ?>&type=dynamic" style="text-decoration:none; color:#111;">
         ...
         <div class="row mt-3">
            <div class="col-md-12">
               <p style="margin-bottom:0px;"><span style="font-size:20px; font-weight:400;">Min Price: </span><span style="font-size:20px; color:#667eea;font-weight:600; ">₹</span><span style="font-size:25px; color:#667eea; font-weight:600;"><?php echo $voucher_min_price."/-" ?></span></p>
               <p style="margin-bottom:0px;"><span style="font-size:20px; font-weight:400;">Max Price: </span><span style="font-size:20px; color:#667eea;font-weight:600; ">₹</span><span style="font-size:25px; color:#667eea; font-weight:600;"><?php echo $voucher_max_price."/-" ?></span></p>
            </div>
         </div>
         <div class="row mt-3">
            <div class="col-md-12">
         ...
         <div class="row mt-5">
            <div class="col-md-12">
               <p style="margin-bottom:0px;"><span style="font-size:20px; font-weight:400;">Buy At: </span>
                  <span id="range_val" style="font-size:20px; font-weight:400;">
                  <?php echo $voucher_max_price;?>
                  </span>
               </p>
               <input type="range" class="custom-range" id="range_input" value="<?php echo $voucher_max_price;?>" name="points1" min="<?php echo $voucher_min_price;?>" max="<?php echo $voucher_max_price;?>"  onInput="rangeValueChange();">
            </div>
         </div>
         <div class="row mt-3">
            <div class="col-6">
      ...
      <div class="row position-fix-bottom-zero">
         <div class="col-12">
            <a id="buy_now_link" href="checkout.php?id=<?php echo $voucher_id ?>&type=dynamic&price=<?php echo $voucher_max_price; ?>" style="text-decoration: none; color: #fff;">
      ...
      <script>
         ...
         function rangeValueChange(){
            var get_range_input = document.getElementById('range_input');
            var get_range_val = document.getElementById('range_val');
            var get_buy_now_link = document.getElementById('buy_now_link');
         
            get_range_val.innerHTML = get_range_input.value;
         
            //changing the link 
         
            get_buy_now_link.href = "checkout.php?id="+voucher_id+"&type=dynamic&price="+get_range_input.value;
          }
      </script>
   </body>
</html>