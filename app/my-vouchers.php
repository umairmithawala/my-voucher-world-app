   ...
   <body>
      ...
      <div id="contain" style="margin-top:80px;" >
         ...
         <?php
            ...
            <p class="text-center" >
                     <a href="already-used-my-vouchers.php" style="text-decoration:none !important;">
                     <span style="font-size:15px; font-weight:600;">
                     View already used <i class="fas fa-chevron-right" style="opacity:0.5; font-size:13px;"></i><i class="fas fa-chevron-right" style="margin-left:-2.5px; font-size:13px;"></i>
                     </span>
                     </a>   
                  </p>
