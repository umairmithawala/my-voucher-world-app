      ...
      if (!empty($_GET['id'])) {
          ...
          if ($rows2 > 0 && $run_query2 == TRUE) { 
            ...
            if($voucher_type == "normal"){
                $query3 = "SELECT `name`,`discount_price` FROM `voucher` WHERE `id` = $voucher_id";
          ...
          if ($rows3 > 0 && $run_query3 == TRUE) { 
            ...
            //get voucher code from voucher code table 

            if($voucher_type == "normal"){
                $query4 = "SELECT `voucher_code` FROM `voucher_code` WHERE `id` = $voucher_code_id";
              }else if($voucher_type == "dynamic"){         
                $query4 = "SELECT `voucher_code` FROM `variable_voucher_code` WHERE `id` = $voucher_code_id";
              }
          ...
          if ($rows4 > 0 && $run_query4 == TRUE) { 
              while ($data4 = mysqli_fetch_assoc($run_query4)) { 
                  ...
                  $voucher_code = $data4['voucher_code'];
          ...
          if($payment_complete_code_not_available == 1){
?>
<script>
         ...
         <div class="container-fluid" style="margin-top:30px; height:100%;">
            <div class="card" style="box-shadow: 0px 1px 15px #d3d3d3; border-radius:10px; height:auto;">
               ...
               <div class="card-footer">
                  <p>
                     <span style="font-size:15px; color:#000000; font-weight:400; float:left; ">
                     <i class="fas fa-info-circle"></i> You can use this code on associated apps and website.
                     </span>
                  </p>
               </div>
            </div>
