...
if(isset($_POST['filter'])){
    $filtered_price = $_POST['filtered_price'];
    $filtered_category = $_POST['filtered_category'];
               ...
               <div class="searchbar-box">
                  <div class="searchbar-box-right">
                     <div class="searchbar-box-right-input">
                        <input type="text" name="search" style="background: #F5F5F5" value="" placeholder=" Search Voucher" />
                     </div>
                  </div>
         ...
         <div class="container-fluid mt-5">
            ...
            <div class="row">
                  ...
                  if($filtered_category != "all"){
                    $query2 = "SELECT * FROM `voucher` WHERE `is_deleted` = 0 AND `codes_available` = 1 AND `category` = $filtered_category  AND `price` < $filtered_price";


                  }else{
                    $query2 = "SELECT * FROM `voucher` WHERE `is_deleted` = 0 AND `codes_available` = 1 AND `price` < $filtered_price";
                  ...
                  <?php 
                     ...
                     <?php 
                      if($filtered_category != "all"){
                        $query2 = "SELECT * FROM `variable_voucher` WHERE `is_deleted` = 0 AND `codes_available` = 1 AND `category` = $filtered_category  AND `max_price` < $filtered_price";
    
    
                      }else{
                        $query2 = "SELECT * FROM `variable_voucher` WHERE `is_deleted` = 0 AND `codes_available` = 1 AND `max_price` < $filtered_price";
