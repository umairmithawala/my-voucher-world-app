      ...
      <div id="contain" style="margin-top:80px;" >
               ...
               <div class="searchbar-box">
                  <div class="searchbar-box-right">
                     <div class="searchbar-box-right-input">
                        <input type="text" name="search" style="background: #F5F5F5" value="<?php echo $search_keyword; ?>" placeholder=" Search Voucher" />
                     </div>
                  </div>
         ...
         <div class="b-head">
               <div class="b-head-right">
                  <div>
                     <span>Search results for <?php echo '"'.$search_keyword.'"' ?></span>
                  </div>
               </div>
         ...
         <div class="container-fluid mt-5">
            ...
            <div class="row">
                   ...
                   <?php
                   $search_keyword_for_like = '%'.$search_keyword.'%';
                   ?>
                  <?php 
                  
                     $query2 = "SELECT * FROM `voucher` WHERE `is_deleted` = 0 AND `codes_available` = 1 AND `name` LIKE '$search_keyword_for_like'";
                  ...
                  <?php 
                     ...
                     ?>
                     <?php 
                     $query2 = "SELECT * FROM `variable_voucher` WHERE `is_deleted` = 0 AND `codes_available` = 1 AND `name` LIKE '$search_keyword_for_like'";
                     $run_query2 = mysqli_query($con, $query2);
                     $rows2     = mysqli_num_rows($run_query2);
